...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-banded@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-base-banded/tags). For example,

```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-banded@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { filled2dBy, toCompact } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-banded@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-banded/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-base-banded/actions/workflows/test.yml?query=branch:v0.1.1
...
[@stdlib/array/base/banded/filled2d-by]: https://github.com/stdlib-js/array-base-banded-filled2d-by/tree/deno

[@stdlib/array/base/banded/to-compact]: https://github.com/stdlib-js/array-base-banded-to-compact/tree/deno
